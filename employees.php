...
if (isset($_POST['insert'])) {
    ...
    $sql = "INSERT INTO patient (name,phone,address,cartnumber,age)
    VALUES ('$name','$phone','$address','$cartnumber','$age')";
...
if(isset($_POST['delete_employee'])){
    ...
    if($result){
        ...
        echo "<script>alert('Employee deleted successfuly')</script>";
...
$sql = "INSERT INTO order1 (order1,order_comment,order_by,created_user_id,created_user_name)
VALUES ('$order1','$order_comment','$order_by','$created_user_id','$created_user_name')";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group form-primary">
            ...
            <input type="text" name="employee_id" class="form-control" placeholder="Confirm Id "  required>
            
        </div>
      </div>
      <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
       <button type="submit" name="delete_employee" class="btn btn-danger btn-block ">Yes confirm</button>
...
<!-- Basic table card start -->
  <div class="card">
    <div class="card-header">
        ...
        <h6 class="text-center"> Employee Application Form</h6>
       
        <div class="col-sm-12">
        
        <a href="new_employee.php"><input type="submit" value=" Apply Now"  class="btn btn-primary btn-block waves-effect text-center m-b-20"> </a>
          ...
          <div class="col-md-6">
          <form  enctype="multipart/form-data" method="POST" action="search_employee.php">
          <center>
          <h6 class="text-center">search date using date</h6>
            <label >From: </label><input type="date" name="from" required>
            <label >To: </label><input type="date" name="to" required>
            
            <input type="submit" value=" Search Data " name="search_data" class="btn btn-primary btn-block waves-effect text-center m-b-20">
            </center>
        </form>
          </div>
        ...
        <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>Licence No</th>
                        <th>Last Job</th>
                        <th>Personal References name<th>
                        <th>Personal References phone<th>
                        <th>Personal References Address<th>
                        <th>Personal References position<th>
                        <th>Someone To contact name<th>
                        <th>Someone To contact phone<th>
                        <th>Someone To contact Address<th>
                        <th>Someone To contact relation<th>
                        <th>Employment Refrence name<th>
                        <th>Employment Refrence phone<th>
                        <th>Employment Refrence Address<th>
                        <th>Employment Refrence position<th>
                        <th>Account name<th>
                        <th>Account no<th>
                        <th>Account info<th>
                        <th>working shift<th>
                        ...
                        <th>Employee position</th>
                        <th>Employee hire</th>
                        <th>Employee statues</th>
                        <th>Employee location</th>
                         
                        <th colspan="14" class="text-center" >Process</th>
          ...
          $result = mysqli_query($conn,$query);
            while($row = mysqli_fetch_assoc($result)){
             ...
             <td><?php echo $row['employee_department']?></td>
             <td><?php echo $row['employee_position']?></td>
             <td><?php echo $row['employee_hire']?></td>
             <td><?php echo $row['employee_statues']?></td>
...
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="new_attendance.php? employee_id='.$employee_id.'" > Attendance </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="new_order.php? employee_id='.$employee_id.'" > Request  </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="investigation.php? employee_id='.$employee_id.'" > Investigation  </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="explanation.php? employee_id='.$employee_id.'" > Explanation  </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="appraisal_report.php? employee_id='.$employee_id.'" > Appraisal1   </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="appraisal2_report.php? employee_id='.$employee_id.'" > Appraisal2   </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="training.php? employee_id='.$employee_id.'" > Trainning    </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="overtime.php? employee_id='.$employee_id.'" > Overtime    </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="medical.php? employee_id='.$employee_id.'" > Medical    </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="insurance.php? employee_id='.$employee_id.'" > Insurance    </a>';?>
</div>
</td>
<td>
<div > 
<?php  echo '<a class="bt btn-primary btn-sm text-light"  href="clearance.php? employee_id='.$employee_id.'" > Clearance    </a>';?>
</div>
</td>
