...
if (isset($_POST['reset'])) {
    ...
    if ($password == $cpassword) {
		...
		if ($result->num_rows > 0) {
			...
			echo "<script>alert('Woops! Email is Not Exists.')</script>";
		}
            ...
            <div class="row">
                <div class="col-sm-12">
                    <!-- Authentication card start -->
                        ...
                        <form  enctype="multipart/form-data" class="md-float-material form-material" method="post" action="reset-password.php" >
                    
                            <div class="auth-box card text-danger">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-center text-c-red">Resetting Password </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit"  name="reset" class="btn btn-round btn-danger btn-md btn-block waves-effect text-center m-b-20">Save Changes</button>
                                        </div>
                                    </div>
                                    <hr/>
