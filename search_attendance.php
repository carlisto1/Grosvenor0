    ...
    <div class="card-block table-border-style">
        <div class="table-responsive">
			...
			if (isset($_POST['search'])){
				...
				$query="select * from `attendance1` where created between '$from' and '$to'";
              ...
              <td >
                ...
                <div > 
                <?php  echo '<a class="bt btn-primary btn-sm text-light"  href="update_attendance.php? id='.$id.'" >Confirm</a>';?>
                </div>
...
<!-- Basic table card start -->
  <div class="card">
    <div class="card-header">
            <h5>Employee Attendance Information By ID</h5>
        ...
        <div class="table-responsive">
            ...
            <table class="table">
              ...
              if (isset($_POST['search_id'])) {
               $employee_id = $_POST['employee_id'];
          $query = "select * from attendance1  where employee_id=$employee_id ORDER BY date1 DESC ;";
          $result = mysqli_query($conn,$query);
