                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h4 class="text-center txt-primary">  Information by ID : <?php echo$id ?> </h4>
                                    </div>
                                </div>
                                
                                <div class="form-group form-primary">
                                    <input  type="textarea" name="name" class="form-control" value=<?php echo$name ?>>
                                ...
                                <div class="col-sm-6">
                                <div class="form-group form-primary">
                                    <input  type="phone" name="cartnumber" class="form-control"  value=<?php echo$address ?>>
                                    <span class="form-bar"></span>
