                                                    ...
                                                    <div class="card-block">
                                                     ...
                                                     <br><br>
                                                      ...
                                                      <div class="col-sm-12">
                                                          ...
                                                          <label class="form-check-label " for="flexSwitchCheckDisabled"><input type="checkbox"checked Required  name="user_name" value=<?php echo $user_name?>>  Process Done by : <?php echo $user_name?> </label>
                                                           <br>
                                                            <hr> 
                                                         </div><br>
                                                         ...
                                                         <h4 class=" col-sm-12 sub-title text-center">  Grosvenor Services Ltd, Khartoum III, Street 51,  Building. 24 - Tel: +249 (0)183 476779 
                                                            Web-Site www.grosvenor-sudan.com<br>	E-mail address: info@grosvenor-sudan.com </h4>
                                                                ...
                                                                <a href=""><input type="submit"  name="attendance" class="btn btn-primary btn-block waves-effect text-center m-b-20"> </a>
