...
if (isset($_POST['pull'])) {
    ...
    echo print_r($_POST,true);
			...
			if ($result) {
               ...
               // header("Location: product_pull.php");
                                                    ...
                                                    <div class="card-block">
                                                     ...
                                                     <br><br>
                                                            ...
                                                            <label class="col-sm-2 col-form-label">Product Type</label>
                                                                ...
                                                                <br><br><br><br><br><br>    
                                                                <label class="col-sm-1 col-form-label">Pull ID</label>
                                                                <div class="col-sm-2">
                                                                    <input type="text" name="pull_id" class="form-control" placeholder="Enter name " Required  value=<?php echo$row['pull_id'] ?> >
                                                                </div>
                                                        
                                                              
                                                                <label class="col-sm-1 col-form-label">Pull By</label>
                                                                <div class="col-sm-2">
                                                                    <input type="text" name="pull_by" class="form-control" placeholder="Enter name " Required  value=<?php echo$row['pull_by'] ?> >
                                                                </div>
                                                                <label class="col-sm-1 col-form-label">Pull Date </label>
                                                                <div class="col-sm-2">
                                                                    <input type="date" name="pull_date" class="form-control" placeholder="Enter date " Required  value=<?php echo$row['pull_date'] ?> >
                                                                </div>
                                                                <label class="col-sm-1 col-form-label">Pull Quantity  </label>
                                                                <div class="col-sm-2">
                                                                <input type="text" name="pull_quantity" class="form-control" placeholder="Enter quantity " Required value=<?php echo$row['pull_quantity'] ?> >
                                                                </div>
                                                                <br><br>
                                                                <label class="col-sm-1 col-form-label">Explaint  </label>
                                                                <div class="col-sm-11">
                                                                    <textarea rows="3" cols="3" class="form-control" name="pull_comment" Required placeholder="job official or training" value=<?php echo$row['pull_comment'] ?>><?php echo$row['pull_comment'] ?> </textarea>
                                                        ...
                                                        <br>
                                                         ...
                                                         <div class="col-sm-12">
                                                          ...
                                                          <div class="form-check form-switch text-center">
                                                           <br>
                                                            <label class="form-check-label" for="flexSwitchCheckDisabled">  <input type='checkbox' checked value=<?php echo $user_name; ?> name='pull_confirmed_by' required>  Confirmed By Employee  <?php echo $user_name; ?> </label><br>
                                                            <label class="form-check-label" for="flexSwitchCheckDisabled">  <input type='checkbox' checked value=<?php echo $user_department; ?> name='user_department' required>  Confirmed By Department <?php echo $user_department; ?> </label>
                                                            <hr> 
                                                         </div><br>
                                                         ...
                                                         <h4 class=" col-sm-12 sub-title text-center">  Grosvenor Services Ltd, Khartoum III, Street 51,  Building. 24 - Tel: +249 (0)183 476779 
                                                            Web-Site www.grosvenor-sudan.com<br>	E-mail address: info@grosvenor-sudan.com </h4>
                                                                ...
                                                                <a href=""><input type="submit" name='pull_update' value="Confirm Now "  class="btn btn-primary btn-block waves-effect text-center m-b-20"> </a>
