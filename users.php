  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group form-primary">
            ...
            <input type="text" name="user_id" class="form-control" placeholder="Confirm Id "  required>
            
        </div>
      </div>
      <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
       <button type="submit" name="delete_user" class="btn btn-danger btn-block ">Yes confirm</button>
...
<!-- Basic table card start -->
  <div class="card">
    <div class="card-header">
        ...
        <h6 class="text-center">Register New User</h6>
       
        <div class="col-sm-12">
        
        <a href="sign-up.php"><input type="submit" value=" New User Form "  class="btn btn-primary btn-block waves-effect text-center m-b-20"> </a>
          ...
          <div class="col-md-6">
          <form enctype="multipart/form-data" method="POST" action="search_user.php">
          <center>
          ...
          <div class="col-md-3">
          <form  enctype="multipart/form-data"method="POST"action="search_user.php">
          <input type="number" placeholder="Search by ID " name="user_id" class="form-control" required> 
          <br>
          ...
          $result = mysqli_query($conn,$query);
            while($row = mysqli_fetch_assoc($result)){
              ...
              <td >
                ...
                <div > 
                <?php  echo '<a  name="comfirm" type="submit" class="bt btn-primary btn-sm text-light"  href="update_user.php? id='.$user_id.'" >Confirm</a>';?>
                </div>
            ...
            <td>
            <div > 
                <?php  echo '<a class="bt btn-primary btn-sm text-light"  href="user_print.php? id='.$user_id.'" >Print</a>';?>
            </div>
            </td>
