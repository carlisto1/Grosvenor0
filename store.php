...
if(isset($_POST['delete_product'])){
    ...
    $sql="delete from store where product_id=$product_id";
    $result=mysqli_query($conn,$sql);
    if($result){
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group form-primary">
            ...
            <input type="text" name="product_id" class="form-control" placeholder="Confirm Id "  required>
            
        </div>
      </div>
      <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
       <button type="submit" name="delete_product" class="btn btn-danger btn-block ">Yes confirm</button>
...
<!-- Basic table card start -->
  <div class="card">
    <div class="card-header">
        <h5>Grosvenor service Store</h5><br><br><br>
        <div class="row">
        <div class="col-md-3">
        <P class="text-center">.</P>
        <h6 class="text-center">Insertnew Items</h6>
       
        <div class="col-sm-12">
        
        <a href="new_store.php"><input type="submit" value="  Hand Over From 1 "  class="btn btn-primary btn-block waves-effect text-center m-b-20"> </a>
          ...
          <div class="col-md-6">
          <form enctype="multipart/form-data" method="POST" action="search_product.php">
          <center>
          ...
          <div class="col-md-3">
          <form  enctype="multipart/form-data"method="POST"action="search_product.php">
          <input type="number" placeholder="Search by ID " name="product_id" class="form-control" required> 
          <br>
...
<div class="card">
    <div class="card-header">
        <h5>Grosvenor service Store Pull Items </h5><br><br><br>
        <div class="row">
        <div class="col-md-3">
        <P class="text-center">.</P>
        <h6 class="text-center">Insertnew Items</h6>
    ...
    <div class="card-block-big table-border-style">
        <div class="table-responsive">
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>pull_date</th>
                        <th>pull_quantity</th>
                        <th>Last Product quantity</th>
                        <th>pull confirmed_by</th>
                        <th>Created Date</th>
                       <th>Updated Date</th>
                       <th> Product ID </th>
                       <th> Product Name</th>
          ...
          $result = mysqli_query($conn,$query);
           ...
           <td><?php echo$row['pull_id']?></td>
           <td><?php echo$row['pull_by']?></td>
           <td><?php echo$row['pull_date']?></td>
           <td><?php echo$row['pull_quantity']?></td>
           <td><?php echo$row['product_quantity']?></td>
           <td><?php echo$row['pull_confirmed_by']?></td>                     
          <td> <?PHP echo$row['created']; ?>  </td>
          <td> <?PHP echo$row['updated']; ?>  </td>
          <td> <?PHP echo$row['product_id']; ?>  </td>
          <td> <?PHP echo$row['product_name']; ?>  </td>
          <td> <?PHP echo$row['product_type']; ?>  </td>
              ...
              <td >
                ...
                <div > 
                <?php  echo '<a class="bt btn-primary btn-sm text-light"  href="update_pull.php? pull_id='.$pull_id.'" >Confirm</a>';?>
                </div>
            ...
            <td>
            <div >
                <?php  echo '<a class="bt btn-danger btn-sm text-light "  data-toggle="modal" data-target="#exampleModal12"  >Delete</a> '; ?>
                </div>
            </td>
            <td>
            <div > 
                <?php  echo '<a class="bt btn-primary btn-sm text-light"  href="pull_print.php? pull_id='.$pull_id.'" >Print</a>';?>
            </div>
            </td>
            <td>
