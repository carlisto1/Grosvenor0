                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form  enctype="multipart/form-data" method="post" action="function.php">
                                                            ...
                                                            <label class="col-sm-2 col-form-label"> Select ID Type</label>
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <input type="text" value='<?php echo $id_number ?>'   name="id_number" class="form-control" placeholder="Enter Date">
                                                                </div>
                                                                <label class="col-sm-2 col-form-label">Release Date</label>
                                                                <div class="col-sm-2">
                                                                    <input type="date" value='<?php echo $release_date ?>'    name="release_date" class="form-control" placeholder=" Enter institution ">
                                                                </div>
                                                                <label class="col-sm-2 col-form-label">Place of Issue  </label>
                                                                <div class="col-sm-2">
                                                                    <input type="text" value='<?php echo $place_of_issue ?>'    name="place_of_issue" class="form-control" placeholder="Enter Date">
                                                                </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                <label class="col-sm-2 col-form-label checkbox-inline" ><input type="checkbox" name="gender_type" value="Male ">Male </label>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                <label class="col-sm-2 col-form-label checkbox-inline" ><input type="checkbox" name="gender_statues" value="Single">Single </label>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                <label class="col-sm-2 col-form-label checkbox-inline" ><input type="checkbox"   name="working_shift"   value="YES">YES </label>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                <label class="col-sm-2 col-form-label checkbox-inline" ><input type="checkbox"  name="working_extra" value="YES">YES </label>
                                                          ...
                                                          <div class="form-check form-switch text-center">
                                                           <br>
                                                            <label class="form-check-label" for="flexSwitchCheckDisabled">  Employee Created Date<?php echo $created ?> </label><br>
                                                            <label class="form-check-label" for="flexSwitchCheckDisabled">  Employee Updated Date<?php echo $updated ?> </label><br>
                                                            <label class="form-check-label" for="flexSwitchCheckDisabled">  Employee Updated By <?php echo $updated_by ?> </label>
                                                            <hr> 
                                                         </div><br>
