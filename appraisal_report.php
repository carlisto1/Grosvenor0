...
if (isset($_POST['apprisal_report'])) {
    ...
    $relationship_colleage=$_POST['relationship_colleage'];
    $time_management=$_POST['time_management'];
    $creativity=$_POST['creativity'];
    $degree_perfect=$_POST['degree_perfect'];
    $good_judgment=$_POST['good_judgment'];
    $self_confidance=$_POST['self_confidance'];
    $using_technology=$_POST['using_technology'];
    $personality=$_POST['personality'];
    $degree_dependancy=$_POST['degree_dependancy'];
    $liability_development=$_POST['liability_development'];
    $relationship_sub=$_POST['relationship_sub'];
...
function s(){
     ...
     alert('Woops! you have no permission to access.')
// <?php 
                                                    ...
                                                    <div class="card-block">
                                                      ...
                                                      <h6 class="col-sm-12">  a. Behavior</h5>
                                                          ...
                                                          <label class="col-sm-2 col-form-label">Appearance (10) </label>
                                                                ...
                                                                <div class="col-sm-1">
                                                                    <input type="number" name='relationship_colleage'  id="n6" class="form-control"  value="<?php echo $row2['relationship_colleage'] ?>">
                                                                </div>
                                                          <label class="col-sm-2 col-form-label">Smartness & understanding (10)  </label>
                                                                ...
                                                                <div class="col-sm-1">
                                                                    <input  type='number' name='creativity' id="n8" class="form-control"  value="<?php echo $row2['memos_metters_writing'] ?>">
                                                                </div>
                                                             ...
                                                             <div class="col-sm-1">
                                                                 <input  type="number" name='degree_dependancy' id="n12" class="form-control"  value="<?php echo $row2['degree_dependancy'] ?>">
                                                                 <BR><BR>
                                                             </div> 
                                                             <h6 class="col-sm-12">  a. Technical</h5>
 
                                                             <label class="col-sm-2 col-form-label">Good Judgment (10)   </label>
                                                                <div class="col-sm-1">
                                                                    <input type="number"  name='good_judgment' id="n10" class="form-control"  value="<?php echo $row2['good_judgment'] ?>">
                                                                </div>
                                                                <label class="col-sm-2 col-form-label">Self Confidance  (10)   </label>
                                                                <div class="col-sm-1">
                                                                    <input type="number"  name='self_confidance' id="n11" class="form-control"  value="<?php echo $row2['self_confidance'] ?>">
                                                                </div>

                                                                <label class="col-sm-2 col-form-label">Relationship With Sub   </label>
                                                             
                                                             <div class="col-sm-1">
                                                                 <input  type="number" name='relationship_sub' id="n12" class="form-control"  value="<?php echo $row2['relationship_sub'] ?>">
                                                             </div> 

                                                             <label class="col-sm-2 col-form-label">Degree of Perfect (10)  </label>
                                                                <div class="col-sm-1">
                                                                    <input type="number" name='degree_perfect'  id="n9" class="form-control"  value="<?php echo $row2['degree_perfect'] ?>">
                                                                    <BR>
                                                                </div>
                                                                
                                                                <label class="col-sm-2 col-form-label">Using Technology (10)  </label>
                                                                <div class="col-sm-1">
                                                                    <input  type="number" name='using_technology' id="n12" class="form-control"  value="<?php echo $row2['using_technology'] ?>">
                                                                </div>
                                                                
                                                                <label class="col-sm-2 col-form-label">Liability for Development   </label>
                                                         
                                                                <div class="col-sm-1">
                                                                    <input  type="number" name='liability_development' id="n12" class="form-control"  value="<?php echo $row2['liability_development'] ?>">
                                                                </div>     
                                                              

                                                                <label class="col-sm-2 col-form-label">Knowledge og work (10)  </label>
                                                                <div class="col-sm-1">
                                                                    <input type="text" id="n4" name="knowledge" class="form-control"  value="<?php echo $row2['knowledge'] ?>">
                                                                </div>
                                                                <label class="col-sm-2 col-form-label">Time Management  (10)  </label>
                                                                <div class="col-sm-1">
                                                                    <input type="number" name='time_management'  id="n7" class="form-control"  value="<?php echo $row2['time_management'] ?>">
                                                                </div>
